...
def create_complaint():
    ...
    existing_response = supabase.table('complaints').select("id, lat, lng, description").execute()
...
def update_complaint_status(complaint_id):
    ...
    try:
        response = supabase.table('complaints').update({"status": data['status']}).eq('id', complaint_id).execute()
